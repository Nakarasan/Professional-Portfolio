    ...
    <div className="space-y-6 md:space-y-12">
      ...
      <div className="flex flex-col lg:flex-row gap-6 md:gap-16 ">
        <div className="lg:w-[50%]">
          <div className="p-1 bg-[#7456FF]/70 rounded-xl shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_8px_8px_20px_4px_rgba(34,211,238,0.2)]">
            <Image
              src={kara}
              alt="profile"
              quality={100}
        ...
        <div className="lg:w-[50%] space-y-4 md:space-y-8 text-textGray text-p2 md:text-p1">
          ...
          <div className="space-y-2 xl:space-y-3">
            <div className="font-poppinsMedium text-p1 md:text-h3 text-white">
